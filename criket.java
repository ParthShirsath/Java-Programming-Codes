...
class Cricket{
    ...
    void accept(){
         ...
         bat_avg=avg(no_of_innings,no_of_times_notout,total_runs);
    }
    static float avg(int no_of_innings,int no_of_times_notout,int total_runs)
    {
        return total_runs/(no_of_innings-no_of_times_notout);
    }
    void display()
    {
